...
namespace ConsoleApp3
{
    class Program
    {
        ...
        {
            Console.WriteLine("UpdateStock - Listner started.");
        ...
        static async Task MainAsync()
        {
            ...
            string SubscriptionName = "UpdateStock"; //"PaymentSucess"; // "UpdateStock";
        ...
        static async Task ProcessMessagesAsync(Message message, CancellationToken token)
        {
           ...
           // var serviceBusMessage = JsonConvert.DeserializeObject<List<User>>(messageBody);
